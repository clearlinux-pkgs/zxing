...
Source0  : https://github.com/zxing-cpp/zxing-cpp/archive/v2.3.0/zxing-cpp-2.3.0.tar.gz
...
%prep
%setup -q -n zxing-cpp-2.3.0
cd %{_builddir}
tar xf %{_sourcedir}/stb-8b5f1f3.tar.gz
cd %{_builddir}/zxing-cpp-2.3.0
mkdir -p stb
cp -r %{_builddir}/stb-8b5f1f37b5b75829fc72d38e7b5d4bcbf8a26d55/* %{_builddir}/zxing-cpp-2.3.0/stb
pushd ..
cp -a zxing-cpp-2.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735831282
mkdir -p clr-build
pushd clr-build
...
-Dstb_SOURCE_DIR=..  -G 'Unix Makefiles'
make  %{?_smp_mflags}
popd
pushd ../buildavx2/
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libZXing.so.2.3.0
